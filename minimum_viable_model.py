...
# plotting options
plot_everything = True  # decide if everything or just the superficial gas velocities should be plotted
plot_U_lb = True  # decide if the superficial gas velocity should be plotted
plot_kLa = True  #
compare_mass_transfer = True  #
