# -*- coding: utf-8 -*-
"""
Created on Wed Mar 31 16:29:17 2021
...
def simulate_reactor():
    ...
    mol_per_sec = 2480 #moles that come into the reactor per second
    heat_duty = final_conversion*mol_per_sec*170 #heat duty in kilowatts
    print('The final conversion is %s percent' % round(final_conversion * 100,2))
    print('the final heat duty is %s kW' %round(heat_duty, 2))
